function inventoryauditmonthwise(database, type) {
	...
	inventoryauditmonthwise.associate = (models) => {
		models.inventoryauditmonthwise.hasOne(models.MachineList, { foreignKey: 'inventory_id',as:"inventory"});
        models.inventoryauditmonthwise.hasOne(models.User, { foreignKey: 'audit_done_by_user_id',as:"audit_done_by_user"});
