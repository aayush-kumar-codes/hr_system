...
router.get("/get_unassigned_inventories",middleware.AuthForHrAdmin,inventoryControllers.getUnassignedInventoryController,handlers.responseForInventory);//done
router.get("/get_inventory_audit_status_month_wise", middleware.AuthForHrAdmin , inventoryControllers.monthwiseAuditStatusController, handlers.responseForInventory);//about to done
router.get("/get_temp_uploaded_inventory_files", middleware.AuthForHrAdmin , inventoryControllers.getTempFilesController, handlers.responseForInventory);

router.post("/delete_temp_uploaded_inventory_file", middleware.AuthForHrAdmin , inventoryControllers.deleteTempFilesControllers, handlers.responseForInventory);
router.post("/inventory_unassign_request", middleware.AuthForHrEmployee , validators.unassignRequestValidator, inventoryControllers.inventoryUnassignRequestController, handlers.responseForInventory);
router.post("/remove_machine_detail", middleware.AuthForHrAdmin , inventoryControllers.removeMachineController, handlers.responseForInventory);
