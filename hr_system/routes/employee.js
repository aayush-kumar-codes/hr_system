...
router.post('/get_user_document',middleware.AuthForHrEmployee,employeeController.getUserDocument,handlers.responseForEmployee);//done
router.post('/get_user_document_by_id',middleware.AuthForHrAdmin ,employeeController.getUserDocumentById,handlers.responseForEmployee)//working
